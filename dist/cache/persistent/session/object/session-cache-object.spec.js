...
describe('Session cache object can store and restore', function () {
    ...
    it('should restore a cache object with return type promise', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a;
    ...
    it('should create a proper PersistentCacheModel when getting items from storage using storeCacheObject', function () { return __awaiter(void 0, void 0, void 0, function () {
        var storageCacheModel, ttlObj;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sessionCache.options.returnType = cache_return_type_enum_1.CacheReturnType.Promise;
                    sessionCache.restoreCacheObject(cacheItems, ttl);
                    return [4 /*yield*/, sessionCache.storeCacheObject()];
                case 1:
