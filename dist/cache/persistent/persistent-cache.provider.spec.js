...
describe('Persistent cache provider', function () { return __awaiter(void 0, void 0, void 0, function () {
    var checkCache;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                checkCache = function (provider, key) { return __awaiter(void 0, void 0, void 0, function () {
                    var containerKey, cacheModel, containerModel;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                containerKey = "cacheContainer" + key;
                                provider.setCache({ key: key, returnType: __1.CacheReturnType.Static }, '[]', 'test');
                            ...
                            case 1:
                                ...
                                cacheModel = provider['storage']
                                    .getStorageItems(storage_keys_constant_1.LocalStorageCacheKey)
                                    .find(function (item) { return item.options.key === key; });
                                containerModel = provider['storage']
                                    .getContainerItems(storage_keys_constant_1.LocalStorageContainerKey)
                                    .find(function (item) { return item.options.key === containerKey; });
                ...
                return [4 /*yield*/, it('should store in the appropriate storage', function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, Promise.all([checkCache(sessionCache, "T" + now), checkCache(storageCache, "T" + (now + 10))])];
                                case 1:
                                    _a.sent();
