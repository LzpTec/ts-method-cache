...
describe('Cache decorator is properly set', function () {
    ...
    it('should work for a getter', function () {
        var i = testCache.testGetter;
        var ii = testCache.testGetter;
        expect(testCache.getterCalled).toEqual(1);
    });
    it('should not work for a setter', function () { return __awaiter(void 0, void 0, void 0, function () {
